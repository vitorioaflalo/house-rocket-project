...
def comercial_distribution(data):
    ...
    st.sidebar.subheader('Selecting Max Yr Built')
    ...
    # plot
    grafico_linha_dia = px.line(df, x='date', y='price')
    st.plotly_chart(grafico_linha_dia, use_container_width=True)
